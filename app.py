...
# Import CORS
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "*"}}, methods=["GET", "POST"])# Initialize the OpenAI client with your API key and base URL
openai = OpenAI(
...
def analyze_stock():
    ...
    try:
        ...
        chat_completion = openai.chat.completions.create(
            ...
            messages=[
                {"role": "syst  em", "content": "You are a stock market analysis assistant."},
